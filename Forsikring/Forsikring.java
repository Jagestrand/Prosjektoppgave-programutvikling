...
public abstract class Forsikring implements Serializable
{
	...
	private Kunde kunde;
	private SkademeldingReg skadeliste;
...
class BilForsikring extends Forsikring implements Serializable
{
	...
	private static int bonus, nestenr = 30000;

	public BilForsikring(Kunde kun, String info, int kat, String eier, String regnr, String merke, String mod, int regår, int kmårlig, int fobeløp)
	{
		super(kun, info, kat);
		eiernavn = eier;
...
class BåtForsikring extends Forsikring implements Serializable
{
	...
	public BåtForsikring(Kunde kun, int beløp, String info, String eier, String regnr, String typ, String mod, int modellår, int lengde, String motortyp, int styrke, int kat, String al)
	{
		super(kun, info, kat);
...
class HusForsikring extends Forsikring implements Serializable
{
	...
	public HusForsikring(Kunde kun, int beløpb, int beløpi, String info, String adr, String type, String mat, String stand, int år, int meter, int kat)
	{
		super(kun, info, kat);
		beløpBygg = beløpb;
		beløpInn = beløpi;
...
class HytteForsikring extends Forsikring implements Serializable
{
	...
	public HytteForsikring(Kunde kun, int beløpb, int beløpi, String info, String adr, String type, String mat, String stand, int år, int meter, int kat)
	{
		super(kun, info, kat);
		beløpBygg = beløpb;
		beløpInn = beløpi;
